...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record11<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, String, byte[]> {

    private static final long serialVersionUID = -614973525;
     ...
     */
    @Override
    public Row11<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, String, byte[]> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, String, byte[]> valuesRow() {
     ...
     */
    @Override
    public CommentRecord value11(byte... value) {
        setAuthorHash(value);
        return this;
    }
     ...
     */
    @Override
    public CommentRecord values(Long value1, Long value2, Long value3, LocalDateTime value4, LocalDateTime value5, CommentStatus value6, String value7, String value8, String value9, String value10, byte[] value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Long id, Long threadId, Long parentId, LocalDateTime creationDate, LocalDateTime lastModificationDate, CommentStatus status, String textSource, String textHtml, String author, String url, byte[] authorHash) {
        super(Comment.COMMENT);
