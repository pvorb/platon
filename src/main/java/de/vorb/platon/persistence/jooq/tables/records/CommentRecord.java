...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record10<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, byte[]> {

    private static final long serialVersionUID = -643903914;
     ...
     */
    @Override
    public Row10<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, byte[]> fieldsRow() {
     ...
     */
    @Override
    public Row10<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String, byte[]> valuesRow() {
     ...
     */
    @Override
    public CommentRecord value10(byte... value) {
        setAuthorHash(value);
        return this;
    }
     ...
     */
    @Override
    public CommentRecord values(Long value1, Long value2, Long value3, LocalDateTime value4, LocalDateTime value5, CommentStatus value6, String value7, String value8, String value9, byte[] value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Long id, Long threadId, Long parentId, LocalDateTime creationDate, LocalDateTime lastModificationDate, CommentStatus status, String text, String author, String url, byte[] authorHash) {
        super(Comment.COMMENT);
