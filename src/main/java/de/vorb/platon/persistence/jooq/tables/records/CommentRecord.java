...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> implements Record9<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String> {

    private static final long serialVersionUID = -675336345;
     ...
     */
    @Override
    public Row9<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, Long, LocalDateTime, LocalDateTime, CommentStatus, String, String, String> valuesRow() {
     ...
     */
    @Override
    public CommentRecord values(Long value1, Long value2, Long value3, LocalDateTime value4, LocalDateTime value5, CommentStatus value6, String value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(Long id, Long threadId, Long parentId, LocalDateTime creationDate, LocalDateTime lastModificationDate, CommentStatus status, String text, String author, String url) {
        super(Comment.COMMENT);
